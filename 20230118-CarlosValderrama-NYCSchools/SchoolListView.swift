...
struct SchoolListView: View {
    ...
    var body: some View {
        ...
        .alert("Unable to download SAT scores, please try again!", isPresented: $schoolListViewModel.didFailToDownloadSATs) {
            Button("Okay") { }
        }
        .navigationDestination(for: SATResults.self) { satResult in
